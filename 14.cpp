...
int main()
{
	...
	case 2://option
		...
		case 1:// start in option
			...
			break;
		case 2://back in  manu
			cout << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl<<endl << "                                                SNAKE " << endl << endl << "                                             START GAME" << endl << endl << "                                              OPTIONS" << endl << endl << "                                               EXIT" << endl;
			cin >> z;
			switch (z) {
